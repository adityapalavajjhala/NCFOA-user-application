    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     /*   Toolbar toolbar = findViewById(R.id.toolbar);
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home,R.id.nav_payments,R.id.nav_order_history,R.id.nav_qr_scanner,R.id.nav_table_menu,R.id.nav_order_current,R.id.nav_app_help,R.id.fragment_button_2)
